...
<?php
      ...
      $result = mysql_query("SELECT * FROM achievements ");
      ?>
	  <br>
	  <br>
	  <br>
...
<div id="container">
  <div id="container_body">
    <div>
      <h2 class="form_title">ACHIEVEMENTS</h2>
	  
	  <font size="5" color="#3380FF">AWARDS: </font>
        ...
        <?php
          while( $row = mysql_fetch_assoc( $result ) ){
					...
					echo "<span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#ff0000'>&nbsp&nbsp{$row['awards']} </span>";
					echo "<br><br><span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#3380FF'>MEDALS:   </span>";
					echo "<span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#ff0000'> &nbsp &nbsp{$row['medals']} </span>";
					echo "<br><br><span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#3380FF'>PARTICIPATION :   </span>";
					echo "<span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#ff0000'> &nbsp &nbsp{$row['participation']} </span>";
	...
	<br>
		...
		<button onclick="location.href = 'updateach.html';" id="sign_user1" class="float-left submit-button" >UPDATE INFO</button>
