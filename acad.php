...
<?php
      ...
      $result = mysql_query("SELECT * FROM academics ");
      ?>
	  <br>
	  <br>
	  <br>
...
<div id="container">
  <div id="container_body">
    <div>
      <h2 class="form_title">ACADEMIC DETAILS</h2>
	  
	  <font size="5" color="#3380FF">10th: </font>
        ...
        <?php
          while( $row = mysql_fetch_assoc( $result ) ){
					...
					echo "<span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#ff0000'>&nbsp&nbsp{$row['ssc']} </span>";
					echo "<br><br><span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#3380FF'>XI/XII:   </span>";
					echo "<span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#ff0000'> &nbsp &nbsp{$row['hsc']} </span>";
					echo "<br><br><span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#3380FF'>GRADUATION :   </span>";
					echo "<span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#ff0000'> &nbsp &nbsp{$row['grad']} </span>";
					echo "<br><br><span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#3380FF'>POST-GRADUATION:   </span>";
					echo "<span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#ff0000'> &nbsp &nbsp{$row['postgrad']} </span>";
	...
	<button onclick="location.href = 'updateacad.html';" id="sign_user1" class="float-left submit-button" >UPDATE INFO</button>
