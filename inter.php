...
<div id="container">
  <div id="container_body">
    <div>
      <h2 class="form_title">INTERESTS / HOBBIES</h2>
	  
	  <font size="5" color="#3380FF">SPORTS: </font>
        ...
        <?php
          while( $row = mysql_fetch_assoc( $result ) ){
					...
					echo "<span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#ff0000'>&nbsp&nbsp{$row['SPORTS']} </span>";
					echo "<br><br><span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#3380FF'>ART:   </span>";
					echo "<span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#ff0000'> &nbsp &nbsp{$row['ART']} </span>";
					echo "<br><br><span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#3380FF'>LITERATURE :   </span>";
					echo "<span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#ff0000'> &nbsp &nbsp{$row['LITERATURE']} </span>";
					echo "<br><br><span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#3380FF'>MUSIC:   </span>";
					echo "<span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#ff0000'> &nbsp &nbsp{$row['MUSIC']} </span>";
					echo "<br><br><span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#3380FF'>OTHERS:   </span>";
					echo "<span style = 'font:25px/21px Arial,tahoma,sans-serif;color:#ff0000'> &nbsp &nbsp{$row['OTHERS']} </span>";
	...
	<button onclick="location.href = 'updateinter.html';" id="sign_user1" class="float-left submit-button" >UPDATE INFO</button>
